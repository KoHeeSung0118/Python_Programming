...
result = tuple(x ** 2 for x in range(11))
print(result)
...
print(f"{result[-1]}점, {result[0]}점")                                                    # ✅ max 점수: 92점, min 점수: 76점

print(f"{max(scores)}점, {min(scores)}점")                                                    # ✅ max 점수: 92점, min 점수: 76점
...
print(tuple(x[0] for x in stocks))                                                    # ✅ ('사과', '바나나', '체리')
print(tuple(x[1] for x in stocks))                                                   # ✅ (1000, 2000, 5000)
print(tuple(x[2] for x in stocks))                                                   # ✅ (5, 3, 2)

# 총 재고 금액 출력
total = sum(price * num for _, price, num in stocks)
total = sum([price * num for _, price, num in stocks])

print(f"{sum(tuple(x[1] * x[2] for x in stocks)):,}원")                                                       # ✅ 총액: 21,000원
...
total = sum(price * num for name, price, num in zip(*stocks))
print(f"총액: {total:,}원")